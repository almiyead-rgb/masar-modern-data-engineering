...
<table dir="ltr" width="100%">
<thead><tr><th width="50%" dir="ltr" lang="en" align="left">English</th><th width="50%" dir="rtl" lang="ar" align="right">العربية</th></tr></thead>
<tbody><tr><td width="50%" dir="ltr" lang="en" align="left" valign="top"><h2>11. Save evidence in the same project</h2><p>Keep the two native reports, recorded histories, completed notebook outputs and LAB04_NOTES.md. The notebook/reference checks do not replace these native outputs. Follow <a href="../../COMPLETION.md">Day 3 completion</a> before handing data to Day 4.</p></td><td width="50%" dir="rtl" lang="ar" align="right" valign="top"><h2>11. احفظ الأدلة في المشروع نفسه</h2><p>احتفظ بتقريري المحرك وسجلات العمليات ومخرجات الدفاتر المنفذة وLAB04_NOTES.md. لا تحل فحوص المرجع أو الدفتر وحدها محل نتائج المحرك. اتبع <a href="../../COMPLETION.md">اكتمال اليوم الثالث</a> قبل تسليم البيانات لليوم الرابع.</p></td></tr></tbody>
</table>
