...
text+=bi('<p>Verified environment: Python 3.11, Java 17, Spark 3.5.8, Delta 3.3.2. This is Day 1 execution evidence, not whole-course certification, a Colab-host test, a cloud benchmark or a distributed-scale guarantee. Days 2–5 are not published in this stage.</p>','<p>البيئة المختبرة: Python 3.11 وJava 17 وSpark 3.5.8 وDelta 3.3.2. هذا دليل تنفيذ اليوم الأول وليس اعتمادًا للدورة كاملة أو اختبارًا لخدمة Colab أو مقارنة سحابية أو ضمان توسع موزع. الأيام 2–5 غير منشورة في هذه المرحلة.</p>')
